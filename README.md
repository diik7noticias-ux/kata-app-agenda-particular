...
- `agenda_particular`      nome tecnico em snake_case (ex: lista_compras)
- `Agenda Particular`   nome visivel (ex: Lista de Compras)
- `org.kata.agendaparticular`        package id (ex: org.kata.listacompras)
- `2026`          ano atual
